...
const WhoTubeMainPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <WhoTubeHeader toggleSidebar={toggleSidebar} />
      <div className="flex flex-1">
        {/* Sidebar */}
        <aside className={`bg-gray-200 w-64 p-4 shadow-md fixed top-0 left-0 h-full md:hidden transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300`}>
          <button
          ...
          <nav>
            ...
            <ul>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">Home</a></li>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">About Us</a></li>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">AI Solutions</a></li>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">Case Studies</a></li>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">Blog</a></li>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">Contact</a></li>
            </ul>
            <h2 className="text-xl font-bold mt-6 mb-4">Categories</h2>
            <ul>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">Machine Learning</a></li>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">Natural Language Processing</a></li>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">Computer Vision</a></li>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">Robotics</a></li>
              <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-600">AI Ethics</a></li>
            </ul>
    ...
    <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <ul>
          ...
          <li className="mb-2"><a href="#" className="hover:text-gray-400">AI Assistance</a></li>
        </ul>
      </div>
      <div>
        <h3 className="text-xl font-bold mb-4">Follow Us</h3>
        <div className="flex space-x-4">
          <a href="#" className="hover:text-gray-400"><img src="./images/icons8-facebook-48.png" alt="Facebook" className="h-8 w-8" /></a>
          <a href="#" className="hover:text-gray-400"><img src="./images/icons8-x-67.png" alt="X" className="h-8 w-8" /></a>
          <a href="#" className="hover:text-gray-400"><img src="./images/icons8-instagram-48.png" alt="Instagram" className="h-8 w-8" /></a>
          <a href="#" className="hover:text-gray-400"><img src="./images/icons8-linkedin-48.png" alt="LinkedIn" className="h-8 w-8" /></a>
        </div>
      </div>
    </div>
